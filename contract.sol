...
abstract contract Project {
    address public marketingWallet = 0x55ba65287f4c4E050dEB8B18E7E9FF4db0b6F72B;
    address public devWallet = 0x55ba65287f4c4E050dEB8B18E7E9FF4db0b6F72B;

    string constant _name = "Dank";
    string constant _symbol = "DANK";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 69 * 10**12 * 10**_decimals;

    uint256 public _maxTxAmount = (5 * 10**12 * 10) / 10000;
    uint256 public _maxWalletToken = (_totalSupply * 10) / 10000; //
 ...
 * MainContract
 */
contract DankContract is Project, IERC20, Ownable {
